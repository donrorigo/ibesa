...
#define OLD 9 /* numero de mutaciones donde se considera la solucion estancada */
...
typedef function<void(single,single &,int, int, vector<unsigned int> &)> mutation_function;
vector<mutation_function> greedy_mutations;
static set<string> fitness_vector;

static void init(int total, string amino_sequence, string CDSs, int machos);
